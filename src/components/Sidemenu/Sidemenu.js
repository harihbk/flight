        ...
        { _flightstatus == "combo"  && 
                ...
                <Box className='filterType2 filter filterRow border'>
                    ...
                    <Box sx={{ marginBottom : 1}}> 
                        <Button className={stopmulticity.status ? "color_secondary" : "outline_primary"}  variant={stopmulticity.status ? "contained" : "outlined"} sx={{ marginRight : 1}} onClick={()=>setStopmulticity(
                            prev=>({
                            ...prev,
                            status : true
                        })
                        ...
                        <Button className={stopmulticity.status ? "outline_primary" : "color_secondary"}   variant={stopmulticity.status ? "outlined" : "contained"} onClick={()=>setStopmulticity(
                            prev=>({
                                ...prev,
                                status : false
                            })
